...
<template>
  <div class="bg-[#ffffff] dark:bg-gray-800  min-h-screen py-[60px]">
    ...
    <div class="flex flex-row items-center justify-center gap-3 mt-[80px]">
      ...
      <h1 class="text-[18px] sm:text-[22px] font-serif font-bold dark:text-white ">云盘搜索站-网盘资源搜索引擎</h1>
    </div>
    ...
    <div class="py-2 h-25 fixed bottom-0 left-0 right-0 bg-white dark:bg-slate-800 space-y-1">
      <div class="flex flex-row items-center justify-center  gap-3">
        <a class="" href="https://www.xbtjx.xyz/">
          <img class="w-5 h-5" src="https://axcdn.axurehub.com/wp-content/uploads/2024/08/4ef8946574bb90a.jpg" alt="小报童专栏精选站">小报童专栏精选站
        </a>
